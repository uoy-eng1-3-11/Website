...
const Features = () => {
    ...
    return (
        <AnimatedContent
            ...
            delay={0.15}
            >
            <div id="features" className='bg-gradient-to-b from-[#2e2e2eb2] to-[rgb(66,82,113)] rounded-lg my-10 2xl:mx-80 max-xl:mx-30 md:mx-20 sm:mx-10 max-sm:mx-5 pb-5  contain-content'>
